...
export default function ResultDashboard(props) {
  return (
    ...
    <Grid item xs={6} cellHeight={200} width ={350} justifyContent="flex-end">
      <b><font size="6">My works</font></b>
      {/* <Image alt="introduction" src={myillust} width={52} height={52}></Image> */}
    ...
    <Grid item xs={6} cellHeight={200} width ={350} justifyContent="flex-end">
       <b><font size="6">Partner&apos;s works</font></b>
       {/* <Image alt="introduction" src={partnerillust} width={52} height={52}></Image> */}
